    ...
    [
      {
        cols: [
          {
            view: "text", 
            id: global_id.list_filter_id,
            on: {
              onTimedKeyPress: function () {
                var value = this.getValue().toLowerCase();
                $$(global_id.userdatatable_id).filter("#name#", value);
              }
            }
          },
          {
            view: "button", value: "Sort asc", click: function () {
              $$(global_id.userdatatable_id).sort('#age#', 'asc');
            }
          },
          {
            view: "button", value: "Sort desc", click: function () {
              $$(global_id.userdatatable_id).sort('#age#', 'desc');
            }
          },
          {
            view: "button", value: "Add user", click: function () {
              const form = $$(global_id.list_filter_id);
              const list = $$(global_id.userdatatable_id);
